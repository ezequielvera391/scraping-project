...
CLIENT_COVERS_PATH = "assets/images/temp/cards/" # Es la ruta del cliente para que el json quede armado correctamente y no necesite modificaciones
CLIENT_POSTERS_PATH = "assets/images/temp/posters/"